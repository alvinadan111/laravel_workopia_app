...
Route::resource('jobs', JobController::class)->middleware('auth')->only(['create', 'update', 'destroy']);
Route::resource('jobs', JobController::class)->except(['create', 'update', 'destroy']);
...
// to test POST req via CLI: 
//   curl -X POST https://laravelfromscratch.test/submit
