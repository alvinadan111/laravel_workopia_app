<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="salary" name="salary" label="Salary" type="number" placeholder="9000"
            ...
            <x-inputs.text id="zipcode" name="zipcode" label="Zipcode" placeholder="2214" :value="old('zipcode', $job->zipcode)" />
